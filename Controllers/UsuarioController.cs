...
namespace ProjetoFinalCaroline.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
