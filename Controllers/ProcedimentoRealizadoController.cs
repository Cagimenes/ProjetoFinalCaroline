...
namespace ProjetoFinalCaroline.Controllers
{
        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            if (pesquisa == null)
            {
                return _context.ProcedimentoRealizado != null ?
                          ...
                          .Include(x => x.Procedimento).ToListAsync()) :
            ...
            else
            {
                var procedimentorealizado =
                    ...
                    .Where(x => x.ObservacaoRealizacao.Contains(pesquisa) || x.Cliente.ClienteNome.Contains(pesquisa) || x.Colaborador.ColaboradorNome.Contains(pesquisa) || x.LocalRealizacao.LocalNome.Contains(pesquisa) || x.Procedimento.ProcedimentoNome.Contains(pesquisa))
                    .OrderBy(x => x.ObservacaoRealizacao);
