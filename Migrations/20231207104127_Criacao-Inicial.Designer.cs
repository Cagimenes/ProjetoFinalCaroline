...
namespace ProjetoFinalCaroline.Migrations
{
    ...
    [Migration("20231207104127_Criacao-Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Colaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.LocalRealizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Procedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.ProcedimentoRealizado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.TipoColaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalCaroline.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalCaroline.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalCaroline.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalCaroline.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalCaroline.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
